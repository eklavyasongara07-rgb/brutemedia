...
description: Ready-to-use prompt templates for activating any agent within the NEXUS multi-agent pipeline. Includes pipeline controller and specialist activation prompts.
---
